...
class PermissionManager {
    constructor() {
        ...
        // Ajoutez immédiatement la commande setpermission
        this.availableCommands.add('setpermission');
        
        // Chargez ensuite les autres commandes et permissions
        try {
            this.loadCommands();
    ...
    loadCommands() {
        ...
        const readCommands = (dir) => {
            ...
            for (const file of files) {
                ...
                if (stat.isDirectory() && file !== 'moderation') {
                    readCommands(filePath);
                } else if (file.endsWith('.js') && file !== 'permissionManager.js') {
                    try {
                        ...
                        // Ignorer les erreurs spécifiques au worker et ESM
                        if (!error.message.includes('WorkerBootstrap') && 
        ...
        try {
            ...
            // Continuer avec les commandes déjà chargées
        }
    }
